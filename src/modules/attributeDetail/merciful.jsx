            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Merciful means to have active compassion for those in need or distress.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">But what if someone doesn’t deserve mercy from me?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I need mercy, but probably don’t deserve it.</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Do I do what is merciful - or what is just?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God can grant merciful forgiveness of sin.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus compassionately connected people to God and His gifts.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How are we “hard-wired" to be merciful?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How did David go from adultery and murder to being known as  the "father" of Jesus?</h1>
                  </section>
                ...
                <section>
                    ...
                    <h1 className="title  tracking-wide padded">"At Calvary" - Newell</h1>
                    </section>
