...
class Saving extends Component {
          ...
          <BaseAttributeDetail
            ...
            definition={
              <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Americans spend about $13,000 annually per person for medical care (in 2021 - much of which is paid indirectly by employers or government), with the primary goal to restore us back to good health, a priceless status.  Although the medical system heroically saves lives, no level of spending can change the inevitability of physical death.</p>
            ...
            struggle={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Every person should love and help other people.  Every person also has needs, some more than others (such as a small child or an aged parent with infirmities).  If I am pouring my life into another person, I may do well to ask myself a few questions:  
                  ...
                  o Do I deliberately respond or impulsively react to their words and actions?  
                  o Am I mistakenly trying to help or give hope where God alone is capable of doing that?</p>
                  <br></br>
                  <Quote scripture="Bear one another’s (unbearable) burdens, and so fulfill the law of Christ…. For each will have to bear his own load (responsibilities).  (Parenthesis mine)" reference="Galatians 6:2,5" />               
              </section>
            }
            whoAmI={
              <section>
 ...
 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Merciful God, you alone can restore our relationship with you.  Not my good works, not my church membership, nor even my sacrifice of praise.  Bring me to the point of realizing that my only hope of salvation is Your work in me.</p>
