...
class Saving extends Component {
    ...
    render() {
        return(
          <BaseAttributeDetail
            title="Saving"
            subtitle="To heal, rescue or restore."
            definition={
              <section>
                  <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Americans spend almost $15,000 annually per person for medical care (in 2023 - much of which is paid indirectly by employers or government), with the primary goal to restore us back to good health, a priceless status.  Although the medical system heroically saves lives, no level of spending can change the inevitability of physical death.</p>
                  <p className="is-size-6 leading-normal padded">Only when I realize the full potential impact  to my physical or spiritual health will I become desperate to find a way out or through it.  I may even feel desperation for another person’s situation, developing a codependency while I try to rescue them from their trouble (which they may not even see).  In either case, my way is fueled by hope.  But if I lose even hope, what then?</p>
              </section>
            }
            emotion={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">A Hail Mary pass.  An experimental medical treatment.  Refugees crowding into unseaworthy boats.  A trip to Las Vegas when already deep in debt.  A man committing adultery and murder, and then asking God for mercy.  The common thread is hope, that a desperate act could save or remedy a situation.  But success is far from guaranteed.</p>
                  <p className="is-size-6 leading-normal padded">Most would take desperate measures to save their own life, even while realizing it will be lost eventually.  But fewer desperately seek an eternal life reconciled with God, which can never be lost.  King David’s desperation (in the verses below) drove him to God as the only Person holding the remedy to his sin.  My sin may not seem as bad as David’s, but any sin puts me in a desperate position, separated from my only hope, the perfectly just and holy God.  Once I realize this, the only sensible action - which some may call desperate -  is to plead for God's rescue, His mercy and salvation through faith in Christ Jesus’ death on the cross. </p>
                  <br></br>
            ...
            fear={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">In 2021, ”there were almost twice as many suicides (48,183) in the United States as there were homicides (26,031). Suicide is the second leading cause of death among individuals between the ages of 15 and 34." - 2023 US CDC data</p>
            ...
            struggle={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Every person should love and help other people.  Every person also has needs, some more than others (such as a small child or an aged parent with infirmities).  If I am pouring my life into another person, I may do well to ask myself a few questions: <br></br><br></br>
                  o Are my efforts helping or hurting the person long term? <br></br> 
                  o Am I encouraging the other to become more independent and grow in the attributes of God? <br></br> 
                  o Have I established any needed boundaries or set proper expectations for the relationship?  <br></br>
                  o Do I deliberately respond or impulsively react to their words and actions?  <br></br>
                  o Am I mistakenly trying to help or give hope where God alone is capable of doing that?</p>
                  <br></br>
                  <Quote scripture="Bear one another’s (unbearable*) burdens, and so fulfill the law of Christ…. For each will have to bear his own load (responsibilities*)." reference="Galatians 6:2,5    * Clarifications to word meanining" />               
              </section>
            }
            question={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("saving")}}>Is my current problem my own fault - or am I just a victim?</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">We all have an intense desire to be blameless, which often causes us to look to others as the source of our woes.  And sometimes we are right!  But even when fault clearly lies with another, our cry and steps for justice by “any means necessary” can itself bring us blame.  An honest look inward at the start is the best first step.  The only one in history truly innocent is Christ, who also is the only perfect liberator - the only One who can make us, and satisfy our desire to be, blameless.</p>
                  <br></br>
                  <Quote scripture="Be kind to one another, tenderhearted, forgiving one another, as God in Christ forgave you." reference="Ephesians 4:32" />               
              </section>
            }
            whoAmI={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("saving")}}>Only God can restore my sin-damaged relationship with Him.</h1>
                </section>
                  <p className="is-size-6 leading-normal padded"> It is madness to believe I can save myself by being good enough to hang out with a holy God.  To hope that I or any other person is naturally good enough or will naturally improve over time ignores both history and current events.</p>
                  <br></br>
 ...
 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Stop trying to justify myself through my works, but rely solely on Jesus’ work on the cross to save me.  Realize that through Jesus' salvation I am free from the impossible law of working to be good enough and the associated judgment of failure.  Let Jesus' salvation increase my love for Him so I'll be motivated to love others in response to the loving remedy He provides me.
 ...
 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Merciful God, you alone can restore my relationship with you.  Not my good works, not my church membership, nor even my sacrifice of praise.  Bring me to the point of realizing that my only hope of salvation is Your work in me.</p>
            ...
            scienceAndHealth={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Christianity views man as sinful - worthy only of God’s wrath - making the need for salvation obvious.  A secularist view typically views man as both good and bad, but getting better (evolving) with time. Which view has more evidence?</p>
                  <p className="is-size-6 leading-normal padded">The secularist view of man’s improvement often points to global stats like the following from a 10/17/18 article from VOX:  'A 70% reduction in poverty over the last 30 years, lifespans doubling over the last century, homicide and violent crimes dropping over the last few decades, literacy and education levels soaring, improved internet accessibility and much lower costs of renewable energy sources.' </p>
                  <p className="is-size-6 leading-normal padded">There is no doubt that life is indeed getting longer and much more comfortable. But is man truly getting better? Christianity’s measures of better are how well we reflect God's image in our lives:  Are we more truthful? More patient, humble and loving? Are we faithful to our commitments? Do we live with more peace and joy? </p>               
              </section>
            }
            attHistory={
              <section>
                  ...
                  <Quote scripture="For unto you is born this day in the city of David a Savior, who is Christ the Lord." reference="Luke 2:11" color="var(--teal)"/>
                  <p className="is-size-6 leading-normal padded">
                  Salvation brought by Christ is celebrated by both Christmas (His birth) and Easter (His resurrection from death on the cross).  The exact day of His birth was not recorded, but is celebrated around the globe.  So how was this date established?</p>
            ...
            liturgy={
              <section>
                 <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("saving")}}>“There Is Power In The Blood” - Lewis Edgar Jones</h1>
                </section>
                  <p className="is-size-6 leading-normal padded">
                Propitiation: The act of appeasing a deity.  In the Old Testament, animal blood was annually spilled on top of the ark of the covenant, deflecting God's wrath from heaven.  This wrath came because of violations of the law, which was physically located in the ark (as stone tablets).  In the New Testament, Christ’s shed blood on the cross served the same saving purpose, though it was a perfect once-for-all-time sacrifice.</p>
