            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <p className="is-size-6 leading-normal padded">It’s an expression most often heard from kids, but just as often thought by adults.  God's justice is consistent and always true, but fairness, like beauty, is found in the eye of the beholder.  And this world has many different eyes, making it very easy for me to be hurt by unfairness.  Then what I need most is to know how to truly  forgive others.  Desmond Tutu said, "Forgiveness is not pretending that things are other than the way they are."" Once I realize and fully accept the real hurt caused by another, I can then choose to release the other from my visions of punishment.</p>
                  <br></br>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-primary tracking-wide padded">Jesus provided a way for me to be made completely right with God.</h1></section>
                ...
                <section>
                  <h1 className="title has-text-primary tracking-wide padded">Where do right and wrong come from - if not God?</h1>
                  </section>
