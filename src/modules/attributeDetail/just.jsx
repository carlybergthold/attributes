            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="Create in me a clean heart, O God; and renew a right spirit within me." reference="Psalm 51:10" color="var(--teal)"/>
                </div>
...
- Desmond Tutu</p>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="There is a way that seems right to a man, but its end is the way to death." reference="Proverbs 14:12" color="var(--teal)"/>
                </div>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Testimonial quote="God has often forgiven sinners, but He never forgives sin; and the sinner is only forgiven on the ground of Another having born his punishment: for 'without shedding of blood there is no remission of sins'. (Hebrews 9:22)." reference="A.W.Pink" color="var(--teal)"/>
                </div>
