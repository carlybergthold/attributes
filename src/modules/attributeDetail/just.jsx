...
class Just extends Component {
    ...
    render() {
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="JustContainer">
              <aside>
                <section id="sidebar">
                  <AttributeSidebar />
                </section>
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Just means to make all things right or good.
                  </h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">So what do I do when faced with unfairness?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">What if I can’t stand being wrong?</h1>
                </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">“That’s not fair!”</h1>
                  </section>
...
- Desmond Tutu</p>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Only God can make all things right.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus provided a way for sinners to be made right with God.</h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Where does right and wrong come from - if not God?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Is the #MeToo movement Biblical?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title has-text-info tracking-wide padded">How Firm A Foundation - Anonymous</h1>
                    </section>
