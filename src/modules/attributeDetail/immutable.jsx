            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Immutable means to be fully consistent or unchanging.
                  </h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Why are the things I most enjoy also the things most threatened?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Why do I fear loss more than I appreciate gain?</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>How can I keep what I already have?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Only God is immutable for eternity.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Jesus was, is, and will always be God.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>We know of nothing in creation which is truly immutable.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>History proves our mutability in that we are constantly changing.</h1>
                  </section>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("immutable")}}>"Rock of Ages" - Augustus  Toplady</h1>
                    </section>
