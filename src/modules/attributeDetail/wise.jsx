            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Wise means to know truth and do good with it.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Where does regret lead me?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How do I avoid the part of a fool?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I keep a healthy perspective?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God is fully wise.</h1>
                </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus was wise in all His words and actions.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Has religion helped or hurt the development of science?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Does more knowledge lead to more wisdom?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Be Thou My Vision" - Byrne</h1>
                    </section>
