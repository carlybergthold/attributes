...
class Wise extends Component {
            ...
            emotion={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Do I make a lot of choices in my life?  The more autonomy I have in my life, the more likely I am to experience regret.  More decisions mean more regret because regret is that feeling of sadness that comes after experiencing the less-than-ideal results of an earlier decision.  Research also shows that I most regret actions TAKEN when I look back over the last few days, but more likely to regret actions NOT TAKEN if I consider the last few years.</p>
                  <p className="is-size-6 leading-normal padded">Everyone makes poor choices at times.  But when my regret becomes negative, repetitive, or self-focused rumination, it can physically harm me and lead to depression.  However, regret can also give me valuable feedback to make sense of the world and avoid future negative behaviors (this is called repentance).  Given this, I must apply generous grace to the past by forgiving myself. But I also need to apply wisdom to the future by learning from my past mistakes and accepting the never-changing truth and wisdom of scripture.</p>
                  <br></br>
 ...
 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Death, poverty and many forms of destruction can be linked to truly foolish behavior. However, a fear of appearing foolish can lead to opportunities lost, progress forgone, and even evil sown. 
</p>
                  <p className="is-size-6 leading-normal padded">Feeling foolish while pursuing what is right and good is a very small price to pay versus plunging into actual foolishness. However, even these plunges can humble me and help build an immunity to further foolishness in the future. They can motivate me to decide in advance what I will do in a similar future circumstance.</p>
                  <p className="is-size-6 leading-normal padded">I desperately need wisdom, based on truth, to know whether to plunge ahead or hold back. If I mistake what is true with what is false, no advance planning will help - I will fall. So I must first search out what is really true and then use it toward my good and the good of others.</p>
                  <br></br>
            ...
            biblicalChristianity={
              <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Although the cross was considered to be foolish by those with worldly wisdom, it was in God’s wisdom that it became His solution for reconciling man to Himself.</p>
            ...
            scienceAndHealth={
              <section>
                <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Both!  The largest initial advancements in science, leading to technology that has vastly improved our lives, was made when men were seeking to understand God and His creation.  But religion, corrupted by power-starved clergy, did oppose some scientific development.  But the true gospel of Christ has always been compatible with, and often a catalyst for, healthy scientific development. </p>
