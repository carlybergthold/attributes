...
class Invisible extends Component {
    ...
    render() {
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="invisibleContainer">
              <aside>
                <section id="sidebar">
                  <AttributeSidebar />
                </section>
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Invisible means to exist beyond our current senses.
                  </h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">But I need God to act now!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Fear of the invisible can be very appropriate.</h1>
                </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">How can I see an invisible God?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Only God is aware of all things invisible.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus in human form was the actual image of invisible God.</h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">We can "see" so much more now of what has for a long time been invisible.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">God is revealing who He is and who we are over history.</h1>
                  </section>
                ...
                <section>
                    <h1 className="title has-text-info tracking-wide padded">Immortal, Invisible, God only Wise - Walter C. Smith</h1>
                    </section>
