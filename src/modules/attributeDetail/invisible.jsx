            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="For we do not wrestle against flesh and blood, but against the rulers, against the authorities, against the cosmic powers over this present darkness, against the spiritual forces of evil in the heavenly places." reference="Ephesians 6:12" color="var(--teal)"/>
                </div>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="But the fruit of the Spirit is love, joy, peace, patience, kindness, goodness, faithfulness, gentleness and self-control.  Against such things there is no law." reference="Galatians 5:22-23" color="var(--teal)"/>
                </div>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Testimonial quote="He (Jesus) is the image of the invisible God." reference="Colossians 1:15a" color="var(--teal)"/>
                  <Testimonial quote="Faith is…being convinced of what we do not see." reference="Hebrews 11:1" color="var(--teal)"/>
                </div>
                ...
                <section>
                  ...
                  <Testimonial quote="For we walk by faith, not by sight." reference="2 Corinthians 5:7" color="var(--teal)"/>
                  <Testimonial quote="So faith comes from hearing, and hearing through the word of Christ." reference="Romans 10:17" color="var(--teal)"/>
                </div>
