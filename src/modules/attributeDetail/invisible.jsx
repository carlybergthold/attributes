            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>Invisible means to exist beyond our current senses.
                  </h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>But I need God to act now!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>Fear of the invisible can be very appropriate.</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>How can I see an invisible God?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>Only God is aware of all things invisible.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>Jesus in human form was the actual image of invisible God.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>How can we see what is invisible?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>God is revealing who He is and who we are over history.</h1>
                  </section>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("invisible")}}>"Immortal, Invisible, God only Wise" - Walter C. Smith</h1>
                    </section>
