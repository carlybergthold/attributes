            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Teaching means to guide others perfectly.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why do I sometimes need a coach or encourager?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I am afraid I may not be able to learn all I need to be successful.</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">When learning itself is a struggle…</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God teaches perfectly.</h1>
                </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus is the perfect teacher.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How was Jesus such a good teacher?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Does Christianity really support learning?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Teach Me Thy Word, O Lord" - Benjamin Mansell Ramsey</h1>
                    </section>
