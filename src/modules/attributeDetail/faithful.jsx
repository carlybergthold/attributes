            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <Quote quote="The works of his hands are faithful and just; all his precepts are trustworthy;" reference="Psalm 111:7" color="var(--teal)"/>
                </div>
                ...
                <section>
                  <h1 className="title has-text-primary tracking-wide padded">God faithfully reveals Himself to us through every part of His creation. </h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-primary tracking-wide padded">The 2000-year global growth of Christianity</h1>
