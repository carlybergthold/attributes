            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="faithfulContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Faithful means able to be trusted. 
                  </h1></section>
                  <p className="is-size-6 leading-normal padded">We want to be considered trustworthy and are distressed when we find others who we cannot trust.  78-90% of Americans (depending on the poll) believe it is morally wrong to commit an adulterous act.  We desire to be faithful to our spouse, favorite sports team, certain brand or personal habit.  But we also fear that our (and other’s) faithfulness may prove to be faulty - from weakness, fatigue, doubt or a change of will.</p>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">How do I avoid being disappointed by others?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">So when should I ever trust another person?</h1>
                </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Why am I sometimes unreliable for others?</h1>
                  </section>
                  ...
                  <br></br>
                  <Testimonial quote="Let what you say be simply ‘Yes’ or ‘No’; anything more than this comes from evil." reference="Matt 5:37" color="var(--teal)"/>
                </div>

                <div className="attSection" id="whoAmI">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Only God is perfectly faithful.</h1></section>
                  ...
                  <br></br>
                  <Testimonial quote="Know therefore that the LORD your God is God, the faithful God who keeps covenant and steadfast love with those who love him and keep his commandments, to a thousand generations," reference="Deut 7:9" color="var(--teal)"quote="But the Lord is faithful. He will establish you and guard you against the evil one." reference="2 Thes 3:3" color="var(--teal)"/>
                </div>

                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus was faithful to His Father.</h1></section>
                  <p className="is-size-6 leading-normal padded">Jesus took on human form and went to the cross as the sacrificial offering which allows for reconciliation of imperfect people to God.  After He completed this work, He joined God in heaven to continue His faithfulness as an advocate, interceding for those who believe in Him.</p>
                ...
                <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Discover what God has actually promised through study of the Bible.  Then test His reliability and find Him faithful.  Along the way, discover that our ability to be faithful to His commands reliably falls short. This is yet another confirmation that what He has already said is true and that He can be trusted. Ask: How have I discovered or tested God’s faithfulness?</p>
                  ...
                  <Testimonial quote="Let us hold fast the confession of our hope without wavering, for he who promised is faithful." reference="Heb 10:23" color="var(--teal)"/>
                </div>

                <div className="attSection has-background-light" id="scienceAndHealth">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">God faithfully reveals Himself to us through every part of His creation.We can either seek the One who is the Cause and Faithful Sustainer of all we discover - or we can simply take pride in our own self-sufficiency and power.  The latter appears to be like a baby who just discovered her hands - it can prove to be quite useful, but it is not of ultimate importance.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">The key leader was killed on a Roman cross while his few disciples foundered in doubt and mourning.  However, after the resurrection, they were so sure it happened that most risked their very lives based on its truth. The humble beginning has grown into the most global and diverse movement ever.</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">Christianity is 31.5% of global population (with Islam at 23.2% and "Unaffiliated" at 16.3%). This is down from 1900 on a % basis (from 34.8%), but up overall since total population has quadrupled since 1900.  Meanwhile, Christianity has become much more global over that period of time. In 1900, Europe and the Americas had the vast majority of the world’s Christians (93%). Sub-Saharan Africa, Asia and Pacific has seen tremendous growth - in 2010, 26% of the world’s Christians lived in Europe, followed by 24.4% in Latin America and the Caribbean, 23.8% in Sub-Saharan Africa, 13.2% in Asia and the Pacific, 12.3% in North America, and 1% in the Middle East and North Africa. - Data from Wikipedia</p>
                  
                </div>

                <div className="attSection" id="liturgy" >
                <section>
                    <h1 className="title has-text-info tracking-wide padded">"Steadfast" - Sandra McCracken   (Note the emphasis on trusting in God's faithfulness versus trusting in my faithfulness to God.)</h1>
                    </section>
                    <p className="is-size-6 leading-normal padded">"I will build my house
