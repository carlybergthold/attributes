    ...
    render() {
        return(
          <BaseAttributeDetail
            ...
            emotion={<section>
            <section>
              <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("creative")}}>What is something new that makes me excited?</h1>
              </section>
            ...
            fear={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("creative")}}>How do I leave my own creative mark on this world?</h1>
            </section>
            ...
            struggle={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("creative")}}>Why was I created?</h1>
              </section>
            ...
            liturgy={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("creative")}}>"All Creatures of our God and King" - Francis of Assisi</h1>
              </section>
