...
class Creative extends Component {
    ...
    render() {
        return(
          <BaseAttributeDetail
            title="Creative"
            subtitle="Make new from nothing"
            definition={<section><section>
            <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Creative means to make something new.
            </h1></section>
            ...
            emotion={<section>
            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>What is something new that makes me excited?</h1>
              </section>
              ...
              For great is the LORD, and greatly to be praised." reference="Psalm 96:1-6"/></section>}

            fear={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>How do I leave my own creative mark on this world?</h1>
            </section>
              ...
              <br></br>
              <Quote scripture="The end of the matter; all has been heard. Fear God and keep his commandments, for this is the whole duty of man." reference="Ecclesiastes 12:13" color="var(--teal)"/></section>}

            struggle={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Why was I created?</h1>
              </section>
            ...
            whoAmI={<section>            <section>
              <h1 className="title  tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Only God can create something from absolutely nothing.</h1>
            </section>
            ...
            soWhat={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>So what do I do now?</h1>
              </section>
            ...
            prayer={<section>              <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Prayer</h1>
              </section>
            ...
            scienceAndHealth={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Science does not rule out the potential of a Creator God</h1>
              </section>
            ...
            history={<section><section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>Have we created life on our own yet?</h1>
              </section>
            ...
            liturgy={<section>            <section>
              <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("creative")}}>"All Creatures of our God and King" - Francis of Assisi</h1>
              </section>
              ...
              And praise the Spirit, Three in One!" - Last verse</p></section>}
        />
        )
    }
