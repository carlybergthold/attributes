...
import Omniscient from '../../images/attributeIcons/Omniscient.png'
...
class Omniscient extends Component {
    ...
    render() {
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="OmniscientContainer">
              <aside>
                <section id="sidebar">
                  <AttributeSidebar />
                </section>
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Omniscient means to know all there is to know - past, present and future.
                  </h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">I think you misunderstood me.</h1>
                  </section>
                  ...
                  <br></br>
                  <Testimonial quote="They kill the widow and the sojourner, and murder the fatherless; and they say, ‘The LORD does not see; the God of Jacob does not perceive.’  Understand, O dullest of the people!  Fools, when will you be wise?  He who planted the ear, does he not hear? He who formed the eye, does he not see? He who disciplines the nations, does he not rebuke? He who teaches man knowledge—the LORD—knows the thoughts of man, that they are but a breath...If the LORD had not been my help, my soul would soon have lived in the land of silence.  When I thought, ‘My foot slips,’ your steadfast love, O LORD, held me up. When the cares of my heart are many, your consolations cheer my soul." reference="Psalm 94:6-11,17-19" color="var(--teal)"/>
                </div>

                <div className="attSection" id="fear">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Can’t I get just a little more information, please?</h1>
                </section>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="Besides being wise, the Preacher also taught the people knowledge, weighing and studying and arranging many proverbs with great care. The Preacher sought to find words of delight, and uprightly he wrote words of truth. The words of the wise are like goads, and like nails firmly fixed are the collected sayings; they are given by one Shepherd. My son, beware of anything beyond these. Of making many books there is no end, and much study is a weariness of the flesh. The end of the matter; all has been heard. Fear God and keep his commandments, for this is the whole duty of man." reference="Ecclesiates 12:9-13" color="var(--teal)"/>
                </div>

                <div className="attSection" id="whoAmI">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Only God is omniscient.</h1></section>
                  ...
                  <br></br>
                  <Testimonial quote="Such knowledge is too wonderful for me; it is high; I cannot attain it." reference="Psalm 139:6" color="var(--teal)"/>
                </div>

                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus is also omniscient.</h1></section>
                ...
                <section>
                  ...
                  <Testimonial quote="Before they call I will answer; while they are yet speaking I will hear." reference="Isaiah 65:24" color="var(--teal)"/>
                </div>
                  ...
                  <Testimonial quote="But the LORD said to Samuel, 'Do not look on his appearance or on the height of his stature, because I have rejected him. For the LORD sees not as man sees: man looks on the outward appearance, but the LORD looks on the heart.'" reference="1 Samuel 16:7" color="var(--teal)"/>
                </div>

                <div className="attSection has-background-light" id="scienceAndHealth">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">The human brain is a finite image of God’s omniscience.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">The right hand often does not know the left. </h1>
                  </section>
