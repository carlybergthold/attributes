        ...
        return(
          <BaseAttributeDetail
            ...
            definition={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("wrathful")}}>Wrathful means to have a just and loving insistence on holiness or justice, leading to appropriate action to restore justice and holiness.
                  </h1></section>
            ...
            liturgy={
              <section>
                 <section>
                    ...
                    <p className="is-size-6 leading-normal padded">After concerns were raised, the lyrics that describe 'the wrath of God' caused the song to be dropped from some hymnals. The issue was primarily with the word 'satisfied' vs 'wrath', but it is important to remember that lyrics do matter. God's love must be accurately considered as including wrath.<br></br>
