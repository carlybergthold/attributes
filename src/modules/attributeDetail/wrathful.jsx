        ...
        return(
          <BaseAttributeDetail
            ...
            fear={
              <section>
                <section>
                  ...
                  <p className="is-size-6 leading-normal padded">Truth has a way of coming out over time, eventually revealing who I am and what I have done.  God’s final judgment spares no one this exposure, though He mercifully provides a remedy to those who trust in Him.</p>
                  <br></br>
            ...
            question={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("wrathful")}}>Is Satan equal to, but just opposite of, Jesus?</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">No.  This is a lie of Satan.  Satan is a created being, subservient to God and is thus limited in influence and power.  Although created for good, Satan chose evil and God allows him to reign for a while before crushing him completely.</p>
                  <br></br>
                  <Quote scripture="Little children, you are from God and have overcome them, for he who is in you is greater than he who is in the world." reference="1 John 4:4" />               
              </section>
            }
            whoAmI={
              <section>
            ...
            liturgy={
              <section>
                 <section>
                    ...
                    But the authors knew that accurate lyrics matter greatly. Getty said, “However, we believe altering the lyrics would remove an essential part of the gospel story as explained throughout Scripture. The main thread of what we see revealed throughout the Old and New Testament is the need for man to be made right with God. The provided path toward reconciliation came through Christ’s predetermined and perfect sacrifice on the cross, satisfying God’s wrath once and for all”  (The Gospel Coalition, Dec 2013).  
