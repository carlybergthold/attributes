            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Independent means to self-exist, dependent upon no others.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Is it good to be content?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Shouldn’t I always work toward being more independent? </h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">What then is the right balance between independence and dependence?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God is fully independent.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">When Jesus was on earth, was He independent from or dependent on His Father?</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Is God bound by creation?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">The US sought independence from Britain - shouldn’t I seek independence from God? </h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Rock of Ages" - Agustus M. Toplady</h1>
                    </section>
