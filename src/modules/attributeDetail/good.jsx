...
class Good extends Component {
    ...
    render() {
        return(
            ...
            <Hero title="Good" subtitle="All that pleases"  />
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>Good means all that pleases God.
                  </h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>Why do I sometimes feel unsatisfied even after I get what I want?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>What do I do if I am not good enough?</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>Only God is good.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>Prayer</h1>
                  </section>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("good")}}>"Come Thou Fount of Every Blessing" - Robert Robison</h1>
                    </section>
