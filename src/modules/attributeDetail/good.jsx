...
class Good extends Component {
    ...
    render() {
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="goodContainer">
              <aside>
                <section id="sidebar">
                  <AttributeSidebar />
                </section>
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Good means all that pleases God.
                  </h1></section>
                  ...
                  <p className="is-size-6 leading-normal padded">I often feel satisfied when I get what I need and desire.  And it’s not just about me - I also like bringing good to others.  I worry, however, that I might not be good enough to attain all I need and desire, or that I might fail others when it matters most.</p>
                </div>

                <div className="attSection" id="emotion">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Why do I sometimes feel unsatisfied even after I get what I want?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">What do I do if I am not good enough?</h1>
                </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">How can I find good in my last failure?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Only God is good.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus was called good by many.</h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Good is not always simply the absence of bad.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">When did Thanksgiving become an officially observed holiday?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title has-text-info tracking-wide padded">"Come Thou Fount of Every Blessing" - Robert Robison (Our need is to "tune our hearts" to what is truly good.)</h1>
                    </section>
