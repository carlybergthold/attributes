            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>Sovereign means to be lord and king, subject to no other authority.
                  </h1></section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>What makes me sad?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>I fear what might happen if I do not have full control of my life.</h1>
                </section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>How am I accountable for anything if God is sovereign?</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>Jesus is the sovereign Lord and King.</h1></section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>A free market caters to my personal sovereignty through choice.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>What has long been considered the key to all power and control?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title added" style={{color: helperMethods.getAttributeColor("sovereign")}}>“Have Thine Own Way, Lord” - Jim Reeves</h1>
                    </section>
