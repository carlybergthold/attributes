            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Gracious means sacrificially loving the undeserved.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I love more deeply?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">What do I do when others return my love and graciousness with abuse?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">What’s wrong with hard work?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God is truly gracious.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <h1 className="title  tracking-wide padded">Jesus was the sacrifice lovingly made and given to us, the undeserving.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Science and health rarely demonstrate grace.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Corrie ten Boom was part of a gracious Dutch family.</h1>
                  </section>
...
“I forgive you, brother!” I cried. “With all my heart!”  - Excerpt from Nov 1972 Guidepost</p>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Grace, Greater Than Our Sin" - Julia Johnson</h1>
                    </section>
