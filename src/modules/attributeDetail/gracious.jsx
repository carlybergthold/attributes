...
class Gracious extends Component {
    ...
    render() {
        return(
          <BaseAttributeDetail
            title="Gracious"
            subtitle="To sacrificially love the undeserved"
            definition={
              <section>
                  <section>
            ...
            emotion={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>How can I love more deeply?</h1>
                  </section>
            ...
            fear={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>What do I do when others return my love and graciousness with abuse?</h1>
                </section>
            ...
            biblicalChristianity={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>Jesus was the sacrifice lovingly made and given to us, the undeserving.</h1></section>
            ...
            soWhat={
              <section>
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>So what do I do now?</h1>
                  </section>
            ...
            prayer={
              <section>
                   <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>Prayer</h1>
                  </section>
            ...
            scienceAndHealth={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>Science and health rarely demonstrate grace.</h1>
                  </section>
...
“I forgive you, brother!” I cried. “With all my heart!”  - Excerpt from Nov 1972 Guidepost</p>                
            ...
            liturgy={
              <section>
                <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("gracious")}}>"Grace, Greater Than Our Sin" - Julia Johnson</h1>
                    </section>
