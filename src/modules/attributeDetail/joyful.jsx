...
class Joyful extends Component {
    ...
    render() {
        return(
          <BaseAttributeDetail
            title="Joyful"
            subtitle="To be cheerful and glad"
            definition={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Joyful means to be cheerful and glad.
                  </h1></section>
                  <p className="is-size-6 leading-normal padded">It feels the same as happiness, so it is always most sought-after, but often only fleetingly achieved, and most sorely missed when not present.  The key difference joy has with happiness is the affection fueling this good feeling. Happiness is generated by getting what we want - joy is produced by truly wanting what we already have.</p>
            ...
            emotion={
              <section>
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>What will really make me happy?</h1>
                  </section>
            ...
            fear={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Why is my happiness so fleeting?</h1>
                </section>
            ...
            struggle={
              <section>
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>How can I truly be joyful in all things?</h1>
                  </section>
            ...
            question={
              <section>
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Does freedom bring me happiness?</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">It certainly can! Many believe they will be happy when they are freed “from” something - money woes, stressful relationships, oppressive rules, and much more - all the while not realizing that these problems often originate from us exercising our own personal freedom.  We overspend on wants and then can’t afford the needs.  We don’t want the hassles from others and then become lonely.  We don’t want to commit our time and then regret a missed opportunity.  True freedom will “free us to do” what will maximize our joy, and this simply never comes from sin. God purposefully frees us from this harmful self-focus so that we might love Him and other people whole-heartedly, which then brings much joy!</p>
                  <br></br>
                  <Quote scripture="So if the Son sets you free, you will be free indeed." reference=" John 8:36" color="var(--teal)"/>                
              </section>
            }
            whoAmI={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Only God is the real source of joy.</h1></section>
            ...
            biblicalChristianity={
              <section>
                   <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Jesus was driven to the cross by joy.</h1></section>
                  <p className="is-size-6 leading-normal padded">Jesus did not go to the cross for God’s joy, because He already had an infinite amount.  But it was for my joy - that which I experience from a reconciled relationship with God.</p>
            ...
            soWhat={
              <section>
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>So what do I do now?</h1>
                  </section>
            ...
            prayer={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>Prayer</h1>
                  </section>
            ...
            scienceAndHealth={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>How does beauty and joy connect?</h1>
                  </section>
            ...
            liturgy={
              <section>
                 <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("joyful")}}>"Joyful, Joyful, We Adore Thee" - Henry J. van Dyke</h1>
                    </section>
