        ...
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              <aside className="has-background-grey-lighter">
                <section id="sidebar">
                  <AttributeSidebar attribute="holy"/>
                </section>
              </aside>
              ...
              <main>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>How do I deal with my guilt against a Holy God?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>How can anyone be good enough for Holy God?</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>I’m as good as most people!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>Only God is truly holy.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>Jesus is the way I become holy.</h1></section>
                ...
                <section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>Holiness is like healthiness.</h1>
                  </section>
...
Despite the numerical superiority of the Arab armies, Israel defended itself each time and won. After each war the Israeli army withdrew from most of the areas it captured. This is unprecedented in world history and shows Israel's willingness to reach peace even at the risk of fighting for its very existence.</p>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("holy")}}>"Holy Holy Holy" - Reginald Heber</h1>
                    </section>
