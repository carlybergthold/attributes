            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Holy means to be made worthy and separated from sin.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How do I deal with my guilt against a Holy God?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can anyone be good enough for Holy God?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I’m as good as most people!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God is truly holy.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus is the way I become holy.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Holiness is like healthiness.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">The Jewish nation of Israel was created by God in order to receive God's word, be separate from those around it, and represent God to the world. </h1>
                  </section>
...
Despite the numerical superiority of the Arab armies, Israel defended itself each time and won. After each war the Israeli army withdrew from most of the areas it captured. This is unprecedented in world history and shows Israel's willingness to reach peace even at the risk of fighting for its very existence.</p>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Holy Holy Holy" - Reginald Heber</h1>
                    </section>
