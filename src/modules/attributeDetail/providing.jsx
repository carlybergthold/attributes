...
to give them their food in due season...When you give it to them, they gather it up; when you open your hand, they are filled with good things. When you hide your face, they are dismayed; when you take away their breath, they die and return to their dust.  When you send forth your Spirit, they are created, and you renew the face of the ground. May the glory of the LORD endure forever; may the LORD rejoice in his works, who looks on the earth and it trembles, who touches the mountains and they smoke! I will sing to the LORD as long as I live; I will sing praise to my God while I have being." reference="Psalm 104:14-15, 27-33"/>               
            ...
            question={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("providing")}}>How important is my current physical life since I will soon be in heaven?</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">The fact that Jesus came into this physical world at all is significant, setting an example for how believers should now live, as well as how we will live in the future.  With His resurrection Jesus was not a mere human who became a god (which may be our misguided hope), nor was He a resuscitation like Lazareth (which may be our cynical view) - but rather His Body was transformed into something completely new.  And Jesus did not suffer humility briefly only to be raised in full glory and power.  He physically remains in His resurrected body forever to serve those He died for - a true servant leader - similar to medieval knights or the visual of the slain lamb ruling all creation.  It is a role we can learn from even in our current physical life.</p>
                  <br></br>
                  <Quote scripture="But in fact Christ has been raised from the dead, the firstfruits of those who have fallen asleep." reference=" 1 Corinthians 15:20" />               
              </section>
            }
            whoAmI={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("providing")}}>Only God is an actual provider.</h1>
                </section>
   ...
   T - Think: Ask basic questions like: Who can I always depend upon?  How has God already provided for me?<br></br>
            ...
            attHistory={
              <section>
                 <section>
                  ...
                  <p className="is-size-6 leading-normal padded">He sure does, and God loves it when we seek Him with all we have.  But He also helps those who can’t help themselves and are not seeking Him.  He even helps those who are currently working against themselves and Him!  Without God’s initiative, no one would ever be reconciled to God.  So the concept that God only helps those who seek Him or who take the initiative is not fully aligned with Biblical truth and is not derived from scripture.</p>
