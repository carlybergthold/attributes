            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <br></br>
                  <Quote scripture=" 'Am I a God at hand,' declares the LORD, 'and not a God far away? Can a man hide himself in secret places so that I cannot see him?' declares the LORD. 'Do I not fill heaven and earth?' declares the LORD." reference="Jer 23:23-24" color="var(--teal)"/>
                </div>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Quote scripture="And behold, I (Jesus speaking) am with you always, to the end of the age." reference="Matt 28:20" color="var(--teal)"/>
                  <Quote scripture="But now in Christ Jesus you who once were far off have been brought near by the blood of Christ." reference="Eph 2:13" color="var(--teal)"/>
                </div>
