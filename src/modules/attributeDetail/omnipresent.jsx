        ...
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              <aside className="has-background-grey-lighter">
                <section id="sidebar">
                  <AttributeSidebar attribute="omnipresent"/>
                </section>
              </aside>
              ...
              <main>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Quote scripture="But now in Christ Jesus you who once were far off have been brought near (to God) by the blood of Christ." reference="Ephesians 2:13" color="var(--teal)"/>
                </div>
