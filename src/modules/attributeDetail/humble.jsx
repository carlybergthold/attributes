            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Humble means rightly considering yourself and elevating others.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why do others make me so angry?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">What makes me act differently depending upon who I am around?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I am so busy right now!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God fully knows Himself and Always elevates others.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus was humble.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Humility is foundational to so much good in this life (as well as the next!)</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Abraham Lincoln, often considered one of the greatest American presidents, was also one of the most humble.</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded"> "Just As I Am" - Charlotte Elliott</h1>
                    </section>
