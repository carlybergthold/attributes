            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="gloriousContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="Ascribe to the LORD, O heavenly beings, ascribe to the LORD glory and strength. Ascribe to the LORD the glory due his name; worship the LORD in the splendor of holiness.….The LORD sits enthroned over the flood; the LORD sits enthroned as king forever.
May the LORD give strength to his people! May the LORD bless his people with peace!" reference="Psalm 29:1-2, 10-11" color="var(--teal)"/>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="Nevertheless, many even of the authorities believed in him, but for fear of the Pharisees they did not confess it, so that they would not be put out of the synagogue;  for they loved the glory that comes from man more than the glory that comes from God." reference="John 12:42-43" color="var(--teal)"/>
                </div>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">We often associate the color white with perfection, cleanliness, or purity. A black object absorbs most of the light that strikes its surface.  White objects reflect all visible light wavelengths (or colors) equally.  God's glory is the “white light” summation of all His combined attributes.  But it can lose its brilliance if not reflected well or if an attribute is over-emphasized to the detriment of others. </h1>
                  </section>
