            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Peaceful means being safe, whole, healthy and complete.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why am I so dissatisfied?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Can I find peace by avoiding all trouble?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I deal with a conflict that just keeps going on and on?</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus is the Prince of Peace.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Worrying, or lack of peace, can make us physically sick.</h1>
                  </section>
...
Twitching
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Has the world ever seen true peace?</h1>
                  </section>
...
Even peace-loving Switzerland had a civil war as recently as 1847, called the Sonderbund War.</p>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"It Is Well With My Soul" - Horatio Spafford</h1>
                    </section>
