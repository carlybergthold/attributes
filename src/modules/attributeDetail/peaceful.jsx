            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Peaceful means being safe, whole, healthy and complete.
                  </h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Why am I so dissatisfied?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Can I find peace by avoiding all trouble?</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>How can I deal with a conflict that just keeps going on and on?</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Jesus is the Prince of Peace.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Worrying, or lack of peace, can make us physically sick.</h1>
                  </section>
...
Twitching
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>Has the world ever seen true peace?</h1>
                  </section>
...
Even peace-loving Switzerland had a civil war as recently as 1847, called the Sonderbund War.</p>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("peaceful")}}>"It Is Well With My Soul" - Horatio Spafford</h1>
                    </section>
