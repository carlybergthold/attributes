...
class Omnipotent extends Component {
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>Omnipotent means to have unlimited power and authority.
                  </h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>I am getting nervous about what I need to do soon.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>I’m afraid I might fail.</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>What if I cannot do what I really need to do?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>Only God is omnipotent.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>Jesus was raised from the dead through the power of resurrection.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>How did God create “the heavens and the earth” - from a scientific perspective?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>Why do we celebrate Easter?</h1>
                  </section>
  ...
  4 - Why did a group of staunchly monotheistic Jewish people in first-century Israel start worshiping a man who was executed on a shameful cross?  And why do people continue to be transformed to the good today?</p>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("omnipotent")}}>"A Mighty Fortress is Our God" - Martin Luther</h1>
                    </section>
