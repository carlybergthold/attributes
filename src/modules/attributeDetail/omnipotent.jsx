...
class Omnipotent extends Component {
    ...
    render() {
        return(
            ...
            <Hero title="Omnipotent" subtitle="To have unlimited power and authority"  />
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("omnipotent")}}>I am getting nervous about what I need to do soon.</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("omnipotent")}}>Jesus was raised from the dead through the power of resurrection.</h1></section>
