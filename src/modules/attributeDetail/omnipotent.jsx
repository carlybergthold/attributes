...
import Omnipotent from '../../images/attributeIcons/Omnipotent.png'
...
class Omnipotent extends Component {
    ...
    render() {
        return(
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="OmnipotentContainer">
              <aside>
                <section id="sidebar">
                  <AttributeSidebar />
                </section>
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Omnipotent means to have unlimited power and authority.
                  </h1></section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">I am getting nervous about what I need to do soon.</h1>
                  </section>
                  ...
                  <br></br>
                  <Testimonial quote="Let all the earth fear the LORD; let all the inhabitants of the world stand in awe of him!  For he spoke, and it came to be; he commanded, and it stood firm.  The LORD brings the counsel of the nations to nothing; he frustrates the plans of the peoples….Our soul waits for the LORD; he is our help and our shield. For our heart is glad in him, because we trust in his holy name.  Let your steadfast love, O LORD, be upon us, even as we hope in you." reference="Psalm 33:8-10, 20-2" color="var(--teal)"/>
                </div>

                <div className="attSection" id="fear">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">I’m afraid I might fail.</h1>
                </section>
                  ...
                  <br></br>
                  <Testimonial quote="For God gave us a spirit not of fear but of power and love and self-control." reference="2 Tim 1:7" color="var(--teal)"/>
                </div>

                <div className="attSection" id="struggle">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">What if I cannot do what I really need to do?</h1>
                  </section>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="I (Paul speaking) can do all things through him (God) who strengthens me." reference="Phil 4:13" color="var(--teal)"/>
                </div>

                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title has-text-info tracking-wide padded">Jesus was raised from the dead through the power of resurrection.</h1></section>
                  ...
                  <Testimonial quote="For the word of the cross is folly to those who are perishing, but to us who are being saved it is the power of God." reference="1 Cor 1:18" color="var(--teal)"/>
                </div>
                ...
                <section>
                  ...
                  <Testimonial quote="Being strengthened with all power, according to his glorious might, for all endurance and patience with joy, giving thanks to the Father, who has qualified you to share in the inheritance of the saints in light." reference="Col 1:11-12" color="var(--teal)"/>
                </div>
                  ...
                  <Testimonial quote="But he (i.e. God) said to me (Paul), 'My grace is sufficient for you, for my power is made perfect in weakness.' Therefore I will boast all the more gladly of my weaknesses, so that the power of Christ may rest upon me. For the sake of Christ, then, I am content with weaknesses, insults, hardships, persecutions, and calamities. For when I am weak, then I am strong." reference="2 Cor 12:9-10" color="var(--teal)"/>
                </div>

                <div className="attSection has-background-light" id="scienceAndHealth">
                <section>
                  <h1 className="title has-text-info tracking-wide padded">How did God create “the heavens and the earth” - from a scientific perspective?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title has-text-info tracking-wide padded">Why do we celebrate Easter?</h1>
                  </section>
