            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="OmnipotentContainer">
              ...
              <main>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="For God gave us a spirit not of fear but of power and love and self-control." reference="2 Timothy 1:7" color="var(--teal)"/>
                </div>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="I (Paul speaking) can do all things through him (God) who strengthens me." reference="Philippians 4:13" color="var(--teal)"/>
                </div>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Testimonial quote="For the word of the cross is folly to those who are perishing, but to us who are being saved it is the power of God." reference="1 Corinthians 1:18" color="var(--teal)"/>
                </div>
