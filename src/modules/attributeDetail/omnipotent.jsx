...
class Omnipotent extends Component {
            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Omnipotent means to have unlimited power and authority.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I am getting nervous about what I need to do soon.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I’m afraid I might fail.</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">What if I cannot do what I really need to do?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God is omnipotent.</h1></section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus was raised from the dead through the power of resurrection.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How did God create “the heavens and the earth” - from a scientific perspective?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why do we celebrate Easter?</h1>
                  </section>
  ...
  4 - Why did a group of staunchly monotheistic Jewish people in first-century Israel start worshiping a man who was executed on a shameful cross?  And why do people continue to be transformed to the good today?</p>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"A Mighty Fortress is Our God" - Martin Luther</h1>
                    </section>
