...
Patience is an acquired trait - something we need to grow into.”</p>
                ...
                <section>
                  ...
                  <br></br>
                  <Testimonial quote="Better is the end of a thing than its beginning, and the patient in spirit is better than the proud in spirit." reference="Ecclesiastes 7:8" color="var(--teal)"/>
                </div>
...
· He waits because as time goes on, it becomes more important and not less to do so.</p>
                ...
                <div className="attSection" id="biblicalChristianity">
                  ...
                  <Testimonial quote="The Lord is not slow to fulfill his promise as some count slowness, but is patient toward you, not wishing that any should perish, but that all should reach repentance." reference="2 Peter 3:9" color="var(--teal)"/>
                </div>
