        ...
        return(
          <BaseAttributeDetail
            ...
            scienceAndHealth={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("truthful")}}>Absolute truth is absolutely elusive.</h1>
                  </section>
            ...
            liturgy={
              <section>
                 <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("truthful")}}>"Battle Hymn" - Julia Howe</h1>
                    </section>
