            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Truthful means providing unobscured reality.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I ever trust someone who is untrustworthy?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I know if I am believing a lie?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How do I know what is true?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Only God knows what is true.</h1>
                </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus is truth.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Absolute truth is absolutely elusive.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Should a doctor tell a patient the truth of a fatal prognosis?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Battle Hymn" - Julia Howe</h1>
                    </section>
