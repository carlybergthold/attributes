            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  ...
                  <p className="is-size-6 leading-normal padded">Because truthfulness is so elusive, I may distrust others because of my prior experiences.  This distrust can cause me to be very careful what I do or say around another.  As I struggle to determine what is true around me, I also need to consider my internal truthfulness - not only what comes out of my mouth, but what I tell myself about who I am and why I do what I do.  Self-deception may be the most difficult untruthfulness I must address.</p>
                </div>

                <div className="attSection" id="emotion">
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>How can I ever trust someone who is untrustworthy?</h1>
                  </section>
                  ...
                  <p className="is-size-6 leading-normal padded">So what if I feel I cannot even trust God?  The Psalmist below felt rejected by God based on his circumstances, which can certainly lower trust levels.  But the Psalmist then clings to foundational truths he does trust - that God is worthy of praise and the source of hope, joy, and salvation, and that He does not reject His own.  He then speaks these truths to his distrusting soul.  Continuously returning to, and resting in, the anchor of fundamental truths is vital.  For a Christian, this means reminding myself of the gospel, who God is, and who I am in Christ.</p>
                  <br></br>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>How can I know if I am believing a lie?</h1>
                </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>How do I know what is true?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>Only God knows what is true.</h1>
                </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>Jesus is truth.</h1></section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>So what do I do now?</h1>
                  </section>
                  ...
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>Prayer</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>Absolute truth is absolutely elusive.</h1>
                  </section>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>Should a doctor tell a patient the truth of a fatal prognosis?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title tracking-wide padded" style={{color: helperMethods.getAttributeColor("truthful")}}>"Battle Hymn" - Julia Howe</h1>
                    </section>
