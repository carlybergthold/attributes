            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Relational means relating to or interacting with others.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why am I so frustrated with one of my closest friends?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How do I keep from being lonely?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">How can I develop better relationships?</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus demonstrated care and intimacy in serving his disciples and close friends.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Good relationships bring good health!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Who was ‘Father Abraham’?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">What is communion?</h1>
                    </section>
