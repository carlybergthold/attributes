...
class Relational extends Component {
    ...
    render() {
        return(
            ...
            <Hero title="Relational" subtitle="To relate to or interact with others"  />
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                ...
                <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("relational")}}>Who was ‘Father Abraham’?</h1>
                  </section>
