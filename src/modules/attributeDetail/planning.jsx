...
class Planning extends Component {
    ...
    render() {
        return(
          <BaseAttributeDetail
            title="Planning"
            subtitle="To perfectly fit everything together"
            definition={
              <section>
                  <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>Planning means to perfectly fit everything together.
                  </h1></section>
                  <p className="is-size-6 leading-normal padded">We love it when our plans come together - whether planning a perfect day,  a dream vacation, or a life well-lived.  The act of planning implies purpose, and without purpose, we feel a diminished reason to live.</p>
                  <p className="is-size-6 leading-normal padded">“The need for purpose is one of the defining characteristics of human beings. Human beings crave purpose and suffer serious psychological difficulties when we don’t have it. Purpose is a fundamental component of a fulfilling life……Another important factor here is that aligning ourselves to a purpose often makes us less self-centered. We feel a part of something bigger, something outside ourselves, and this makes us less focused on our own worries and anxieties. Our own problems seem less significant, and we spend less time thinking about them, and so our sense of well-being increases.” - Psychology Today 7/21/13 article, “The Power of Purpose” (God's wisdom shining though a secular source)</p>
            ...
            struggle={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>I really want my plans to work perfectly!</h1>
                  </section>
            ...
            whoAmI={
              <section>
                 <section>
                  ...
                  <br></br>
                  <Quote scripture="I know that you (God) can do all things, and that no purpose of yours can be thwarted." reference="Job 42:2" />               
              </section>
            }
            biblicalChristianity={
              <section>
                   <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>Jesus’ death and resurrection was the key element of God’s plan for history.</h1></section>
                  <p className="is-size-6 leading-normal padded">This vital part of God’s plan was mysteriously hidden for centuries. Even when Jesus spoke of the cross to His disciples, they did not understand it (or chose to deny it).  Even now, after the cross has been fully unveiled, many still choose to deny it or don't understand it. </p>
            ...
            soWhat={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>So what do I do now?</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">Accept, even within my own planning and especially when difficulties arise, that God’s plan is made and executed with the full force of all His attributes. For believers, the driving force of His plan is His never-ending love and goodness, which He pours into all His plans.  <br></br>Ask: How could my most recent difficulty cause me good?</p>
            ...
            prayer={
              <section>
                   <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>Prayer</h1>
                  </section>
                  <p className="is-size-6 leading-normal padded">God, I often pay more attention to things of man versus You and Your Word.  I often fail to trust and follow You completely.   Help me to clearly perceive and align with Your plan as it is lovingly communicated in Your Word and reinforced by Your Spirit.  Not my will, Lord, but Yours.</p>
            ...
            scienceAndHealth={
              <section>
                 <section>
                  <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>A sense of purpose is healthy!</h1>
                  </section>
            ...
            liturgy={
              <section>
                 <section>
                    <h1 className="title tracking-wide padded" style={{color: styleMethods.getAttributeColor("planning")}}>"Be Thou My Vision" - Dallan Forgaill</h1>
                    </section>
                    <p className="is-size-6 leading-normal padded">Although our plans are foremost in our minds, we can consciously sing our way toward God’s plan. </p>
