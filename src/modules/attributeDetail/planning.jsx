            ...
            <div className="container is-fullhd has-text-left relativeMaybe" id="attributeContainer">
              ...
              <main>
                <div className="attSection" id="definition">
                  <section>
                  <h1 className="title  tracking-wide padded">Planning means to perfectly fit everything together.
                  </h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why do I worry so much?</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why even plan when the future looks so uncertain and scary?</h1>
                </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">I really want my plans to work perfectly!</h1>
                  </section>
                ...
                <div className="attSection" id="biblicalChristianity">
                  <section>
                  <h1 className="title  tracking-wide padded">Jesus’ death and resurrection was the key element of God’s plan for history.</h1></section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">A sense of purpose is healthy!</h1>
                  </section>
                ...
                <section>
                  <h1 className="title  tracking-wide padded">Why Jesus came at the perfect time in history?</h1>
                  </section>
                ...
                <section>
                    <h1 className="title  tracking-wide padded">"Be Thou My Vision" - Dallan Forgaill</h1>
                    </section>
